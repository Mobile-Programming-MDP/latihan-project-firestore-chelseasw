...
// mengambil dan menampilkan data di firebase ke ui
  Stream<QuerySnapshot<Object?>> ambilData() {
    return userRef
        .snapshots(); //snapshots akan mengambil seluruh data di collection
  }

//TAMBAH
  void tambah(UserData userData) {
    DocumentReference documentReference =
        userRef.doc(userData.nama); //nama doc diambil dari nama
...
//UBAH
  void ubah(UserData userData) {
    DocumentReference documentReference =
        userRef.doc(userData.nama); //key nya nama
